...
type PixiuClient interface {
	...
	DeletePixiu(ctx context.Context, in *PixiuRequest, opts ...grpc.CallOption) (*PixiuReply, error)
}
...
func (c *pixiuClient) DeletePixiu(ctx context.Context, in *PixiuRequest, opts ...grpc.CallOption) (*PixiuReply, error) {
	out := new(PixiuReply)
	err := c.cc.Invoke(ctx, "/pixiu.Pixiu/DeletePixiu", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixiuServer interface {
	...
	DeletePixiu(context.Context, *PixiuRequest) (*PixiuReply, error)
...
func (UnimplementedPixiuServer) DeletePixiu(context.Context, *PixiuRequest) (*PixiuReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeletePixiu not implemented")
}
...
func _Pixiu_DeletePixiu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PixiuRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PixiuServer).DeletePixiu(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pixiu.Pixiu/DeletePixiu",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixiuServer).DeletePixiu(ctx, req.(*PixiuRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Pixiu_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeletePixiu",
			Handler:    _Pixiu_DeletePixiu_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pixiu-grpc/pixiu/pixiu.proto",
}
